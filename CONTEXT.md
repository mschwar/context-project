---
generated: '2026-03-18T22:35:30Z'
generator: ctx/0.8.0
model: claude-haiku-4-5-20251001
content_hash: sha256:920d06b491df3239ba8d6a1d9172acc0fc8ec35720c99fc9519bdac521d5bef5
files: 19
dirs: 8
tokens_total: 15117
---
...
A filesystem-native manifest generation system (ctx) that creates and maintains CONTEXT.md hierarchies to enable AI agents to navigate and understand codebases through automated directory summarization and git-aware change detection.
...
- **src/** — Source code for ctx, a filesystem-native context layer that generates and maintains CONTEXT.md manifests for AI agents through LLM-powered directory summarization and git-aware change detection.
...
## Notes
- The project follows an agent-first architecture with agentic SDLC workflows documented in CONTRIBUTING.md and AGENT_FIRST_OVERHAUL.md.
- Pre-commit hooks and commitlint enforce manifest freshness and conventional commit standards before commits.
- ctx is distributed as both a Python package (pyproject.toml) and Node.js tool with MCP server integration (mcp.json) for multi-platform agent access.
- Engineering standards, testing strategies, and manifest protocol compliance are centralized in rules.md; operational procedures are in RUNBOOK.md.
- Gate closeout sequences (GATE_CLOSEOUT.md) define mandatory validation and sign-off workflows for each project phase.
