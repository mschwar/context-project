...
- **Test Coverage:** 379 tests passing across all modules.
...
- [ ] **4.1 AGENTS.md rewrite** — machine-readable 9-section onboarding contract with `schema_version: 1`.
- [ ] **4.2 README.md demotion** — ~40 lines, human pitch + link to AGENTS.md.
- [ ] **4.3 Manifest footer** — `<!-- Generated by ctx -->` appended to every CONTEXT.md (not included in hash).
