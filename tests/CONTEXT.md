---
generated: '2026-03-18T22:47:15Z'
generator: ctx/0.8.0
model: claude-haiku-4-5-20251001
content_hash: sha256:5d0246056301096b6bc4bfa63fd0b6ee2bd7b6b92e483683514a51bfe004cfee
files: 36
dirs: 1
tokens_total: 37181
---
...
Comprehensive test suite covering CLI commands, language parsers, manifest generation, LLM integration, and agent workflows.
...
- **test_api.py** — Unit tests for the unified API module covering refresh strategies, configuration, guardrails, and command modes.
...
## Notes
- Parser tests are organized by language (Python, JavaScript/TypeScript, Go, Rust, Java, C#, Kotlin, PHP, Ruby, Swift, Elixir) and validate extraction of public symbols and type information.
- Integration tests use a fake LLM client and sample project fixtures to verify end-to-end manifest generation workflows.
- Configuration and CLI tests validate precedence rules, command wiring, and backward compatibility with legacy command surfaces.
- Git integration tests cover changed file detection and unborn HEAD handling; hasher tests validate staleness detection and ignore pattern matching.
- MCP server and HTTP server tests verify tool invocation, error handling, and manifest retrieval for agent handoff scenarios.
