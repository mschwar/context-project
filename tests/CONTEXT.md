---
generated: '2026-03-18T21:06:43Z'
generator: ctx/0.8.0
model: claude-haiku-4-5-20251001
content_hash: sha256:e785633682bae76430586594975b0f7006c62422d3b718a96b2f8501a779f6d7
files: 36
dirs: 1
tokens_total: 37118
---
...
Comprehensive test suite covering unit, integration, and end-to-end testing for the context project including CLI, API, parsers, and server components.
...
- **test_docs.py** — Unit tests validating documentation structure, metadata presence, and canonical command usage across project files.
...
- Language parser tests are organized by file extension and cover extraction of public APIs, type definitions, and callable signatures across 12+ supported languages.
- CLI and API tests validate end-to-end workflows including configuration precedence, dependency injection, and output formatting.
- Integration tests use a fake LLM client and sample project fixtures to verify manifest generation without external service calls.
