---
generated: '2026-03-18T20:16:24Z'
generator: ctx/0.8.0
model: claude-haiku-4-5-20251001
content_hash: sha256:9932b99ea95458c0e42aa9b912032401f8a098b57ca2fd34e3e3bb8cbeed8224
files: 36
dirs: 1
tokens_total: 36581
---
...
- **test_mcp_server.py** — Tests for the stdio MCP server covering initialization, tool calls, JSON-RPC protocol, and security.
...
- Test organization follows a modular pattern with dedicated test files for each major component (parsers, CLI, API, server, Git integration).
- Language parser tests (test_*_parser.py) validate extraction of language-specific constructs across 10+ supported languages.
- Integration tests (test_integration.py, test_cli.py) use fixtures and fake LLM clients to verify end-to-end workflows.
